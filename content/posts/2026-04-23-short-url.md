...
- **短網址（Short URL）：**  
  <https://url-shortener-beta-coral.vercel.app/twLgDN>
...
使用者在瀏覽器輸入或點擊短網址：<https://url-shortener-beta-coral.vercel.app/twLgDN> ，此時請求會被送往短網址服務的伺服器。這類伺服器通常是邊緣節點（Edge server）或 API server。
